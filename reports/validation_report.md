...
| Repository packaging hygiene | tracked_files=9732, issues=0 | PASS |
...
| Check | Observed | Status |
|---|---|---|
| Actual image decoding | NOT_RUN_IMAGES_NOT_INCLUDED | NOT_RUN_IMAGES_NOT_INCLUDED |
| Actual image-size verification | NOT_RUN_IMAGES_NOT_INCLUDED | NOT_RUN_IMAGES_NOT_INCLUDED |
| Actual image SHA-256 recomputation | NOT_RUN_IMAGES_NOT_INCLUDED | NOT_RUN_IMAGES_NOT_INCLUDED |
| Current perceptual-hash scan | NOT_RUN_IMAGES_NOT_INCLUDED | NOT_RUN_IMAGES_NOT_INCLUDED |
| Visual contact-sheet regeneration | NOT_RUN_IMAGES_NOT_INCLUDED | NOT_RUN_IMAGES_NOT_INCLUDED |
...
- Current perceptual scan: NOT_RUN_IMAGES_NOT_INCLUDED
